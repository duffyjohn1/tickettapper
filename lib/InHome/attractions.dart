...
class StripeApi extends StatefulWidget {
  @override
  _StripeApiState createState() => new _StripeApiState();
}

class _StripeApiState extends State<StripeApi> {
  ...
  void initState() {
    ...
    Stripe.init('pk_test_dTuH609zrOqrwzhRj0D6zs62');
  }
  ...
  // sk_test_bkBdCrEOz1nAdJVpQVrDlLE7
